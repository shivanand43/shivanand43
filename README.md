...
🚀 Full Stack Developer with hands-on experience building scalable web and mobile applications using **Next.js, React.js, React Native, Node.js and MongoDB**.

⚡ Passionate about building responsive UI architectures, reusable components, dashboard systems and modern user experiences.

📱 Experienced in authentication systems, REST API integration, Redux state management and cross-platform mobile application development.
